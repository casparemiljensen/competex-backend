...
namespace competex_backend.API.Controllers
{
    ...
    [ApiController]
    public class ClubsController : GenericsController<ClubDTO>, IClubAPI
    {
        private IClubMembershipService _clubMembershipService;
        public ClubsController(IGenericService<ClubDTO> service, IClubMembershipService clubMembershipService) : base(service)
        {
